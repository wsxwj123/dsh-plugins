// dsh-session-manager dual-half build.
//
// Node target (unchanged): the Cordis host half — `lib/{index,handler,trash,
// paths}.js`. Pure dependency-injected core over node builtins + injected
// cordis services; everything is inlined, no external runtime table.
//
// Browser target (added for the client half): mirrors the official DSH
// client-bundle preset (see dsh-better-sidebar / dsh-turn-scrubber):
