/**
 * Loopback trust fence for every /sm/* request.
 *
 ...
 * reproduce it here because the /sm surface is a raw HTTP route (see the wire
 ...
 */
export function isTrustedSmRequest(req: IncomingMessage): boolean {
