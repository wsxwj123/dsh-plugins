...
/** 构造推送 payload（contract 固定的五个字段） */
function buildPayload(kind, toolName) {
  return {
    kind,
    agent_source: 'dsh',
